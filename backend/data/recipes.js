...
/**
 * 식품 보관 정보 데이터
 * 각 객체는 식품의 이름, 최적 보관 기간, 보관 팁, 상함 정보,
 * 알레르기 정보 및 보관 조건별 소비기한을 포함합니다.
 *
 * - name: 식품 이름 (string)
 * - defaultStorePeriod: 최적의 방법으로 보관 시 권장 소비기한 (number, 일)
 * - storageTips: 보관 팁 (string)
 * - spoilageInfo: 상함 식별 정보 (string)
 * - allergyInfo: 알레르기 유발 물질 정보 (string)
 * - shelfLife: 보관 조건별 소비기한 (object)
 * - unopened: 미개봉 상태 (object)
 * - opened: 개봉 후 상태 (object)
 * - room_temp: 상온 보관 (number|null, 일)
 * - fridge: 냉장 보관 (number|null, 일)
 * - freezer: 냉동 보관 (number|null, 일)
 */
const ingredientMasterData = [
    {
        name: "깻잎",
        defaultStorePeriod: 21,
  ...
  },
  {
    ...
    allergyInfo: "",
    shelfLife: {
      unopened: { room_temp: 14, fridge: null, freezer: null },
      opened: { room_temp: null, fridge: 3, freezer: 60 }
    }
  },
  {
  ...
  {
    name: "소금",
    defaultStorePeriod: null,
    storageTips: "습기를 흡수하면 굳을 수 있으므로 밀폐 용기에 담아 건조하고 서늘한 곳에 보관하세요.",
    spoilageInfo: "이물질이 들어가거나 냄새가 변하지 않는 한 반영구적으로 사용 가능합니다.",
    allergyInfo: "",
    shelfLife: {
  ...
  },
  {
    name: "설탕",
    defaultStorePeriod: null,
    storageTips: "냄새와 습기를 잘 흡수하므로 밀폐 용기에 담아 건조하고 서늘한 곳에 보관하세요.",
    spoilageInfo: "굳는 것은 정상이지만, 이물질이 들어가거나 냄새가 변하면 사용하지 마세요.",
    allergyInfo: "",
    shelfLife: {
      unopened: { room_temp: null, fridge: null, freezer: null },
      opened: { room_temp: null, fridge: null, freezer: null }
  ...
  },
  {
    ...
    shelfLife: {
      unopened: { room_temp: 730, fridge: 730, freezer: null },
      opened: { room_temp: 30, fridge: 180, freezer: null }
    }
  },
  {
    name: "된장",
  ...
  },
  {
    name: "참기름",
    defaultStorePeriod: 90,
    storageTips: "빛과 열에 약하므로, 어둡고 서늘한 곳에 보관하세요. 냉장 보관 시 굳을 수 있으므로 권장하지 않습니다.",
    spoilageInfo: "기름에 절은 듯한 쩐내가 나면 산패한 것입니다.",
    allergyInfo: "참깨",
    shelfLife: {
      unopened: { room_temp: 365, fridge: null, freezer: null },
      opened: { room_temp: 90, fridge: null, freezer: null }
    }
  },
  {
    name: "식초",
  ...
  },
  {
    name: "후추",
    defaultStorePeriod: 365,
    storageTips: "향을 최상으로 유지하려면 통후추를 구매하여 사용할 때마다 갈아서 사용하는 것이 좋습니다. 습기를 피해 밀폐하여 서늘하고 건조한 곳에 보관하세요.",
